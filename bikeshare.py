...
def get_filters():
 ...
 # get user input for month (all, january, february, ... , june)
    while True:
        ...
        month = input("\n Which month would you like to choose? (January, February, March, April, May, June)? Type 'All' for all data\n").title()
        if month in months:
            break
        else:
            print("\n Try again")    
...
# get user input for day of week (all, monday, tuesday, ... sunday)
    while True:
        ...
        day = input("\n Choose a day of the week (Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday)? Type 'All' for all the data \n").title()         
        if day in days:
            break
        else:
            print("\n Try again")    
...
def time_stats(df,month,day):
   ...
   if month =='All':
        ...
        print("The most traveled month is",pop_month)
    
    # display the most common day of week
   if day =='All':
        pop_day= df['day_of_week'].mode()[0]
        print("The most traveled day is",pop_day)
